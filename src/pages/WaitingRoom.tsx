  ...
  return (
    <div className="bg-white flex max-w-[480px] w-full flex-col overflow-hidden mx-auto min-h-screen">
      ...
      <div className="mx-4 mb-4 bg-purple-400 rounded-2xl p-6 text-white text-center">
        ...
        <button className="w-full bg-gray-900 text-white py-3 rounded-xl font-medium mb-3">
          Join Room
        </button>
        
        <p className="text-xs opacity-75">Great News! Skip Waiting—Try Clothes Virtually Now</p>
      </div>
