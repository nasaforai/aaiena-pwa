  ...
  return (
    <div className="bg-white flex max-w-[480px] w-full flex-col overflow-hidden mx-auto min-h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
        ...
        {/* Title */}
        <h1 className="text-2xl font-bold text-gray-900 mb-2 text-center">Device Connected!</h1>
        <p className="text-gray-600 text-center mb-12">Continue Your Experience Seamlessly</p>
