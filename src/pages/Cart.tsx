    ...
    <div className="bg-white flex max-w-[480px] w-full flex-col overflow-hidden mx-auto min-h-screen">
      ...
      <div className="flex-1 p-4">
        {cartItems.map((item, index) => (
          <div key={index} className="flex items-start space-x-3 mb-4 bg-gray-50 rounded-lg p-3">
            <img 
              src={item.image} 
              alt={item.name}
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-2">Size : {item.size} Qty {item.quantity}</p>
        ...
        <div className="bg-gradient-to-r from-purple-400 to-pink-400 rounded-xl p-4 text-white mb-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm opacity-90">Save rs.400 on your first order</p>
            </div>
        ...
        <div className="bg-yellow-100 rounded-xl p-4 mb-6">
          <h3 className="font-semibold text-gray-900 mb-3">Proceed to try product</h3>
      ...
      <div className="bg-gray-50 p-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xl font-bold text-gray-900">₹{getTotal() - 100}</p>
            <button className="text-sm text-orange-600 underline">View Details</button>
          </div>
          <Button 
