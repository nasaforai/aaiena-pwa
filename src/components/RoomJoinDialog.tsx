...
export const RoomJoinDialog: React.FC<RoomJoinDialogProps> = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-sm mx-auto p-0 gap-0 bg-white rounded-2xl overflow-hidden">
        {dialogState === 'form' && (
          <>
            {/* Header */}
            <div className="bg-purple-500 text-white p-4 relative">
              ...
              <p className="text-sm opacity-90">We'll Send Updates To Your Phone.</p>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">Session Expired</span>
              </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">We'll text you when your room is ready.</p>
              </div>
              ...
              <p className="text-xs text-gray-500 text-center">
                Your room will be reserved for 10 minutes after confirmation
              </p>
            </div>
          </>
        )}
        ...
        {dialogState === 'checking' && (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Checking your room availability.</h3>
            <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
              <div className="bg-purple-500 h-2 rounded-full w-1/3 animate-pulse"></div>
            </div>
            <p className="text-sm text-gray-600">"In Aaaina, we help you save your time."</p>
          </div>
        )}
        ...
        {dialogState === 'confirmed' && (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Thank You For Confirmation</h3>
            <p className="text-sm text-gray-600 mb-6">We'll Notify You About Your Room.</p>
            <Button 
