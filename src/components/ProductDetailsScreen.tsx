...
export const ProductDetailsScreen: React.FC<ProductDetailsScreenProps> = ({
  ...
  return <div className="bg-white flex max-w-[480px] w-full flex-col overflow-hidden mx-auto min-h-screen">
      {/* Header */}
      ...
      <div className="px-4 mb-6">
        ...
        <div className="flex justify-between items-start">
          <div className="flex space-x-2">
            {sizes.map(size => <button key={size} onClick={() => setSelectedSize(size)} className={`px-3 py-2 border rounded-lg text-sm font-medium ${selectedSize === size ? 'border-blue-500 bg-blue-50 text-blue-600' : 'border-gray-200 text-gray-700'}`}>
                {size}
              </button>)}
          </div>
          <div className="flex space-x-2">
      ...
      <div className="px-4 mb-6">
        ...
        <div className="flex space-x-3">
          {[1, 2, 3].map(item => <div key={item} className="flex-1 bg-gray-100 rounded-2xl overflow-hidden">
      ...
      <div className="px-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[1, 2].map(item => <div key={item} className="bg-gray-100 rounded-2xl overflow-hidden">
