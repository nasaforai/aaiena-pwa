...
export const PWAInstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 bg-white rounded-lg shadow-lg p-4 z-50 max-w-sm mx-auto border">
      <div className="flex flex-col gap-3">
        <div>
          <h3 className="text-lg font-medium text-[#12002C]">Install Fashion Lane</h3>
